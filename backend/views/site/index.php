                        ...
                        <div class="mt-comments">
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar1.jpg'); ?>" /> </div>
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar6.jpg'); ?>" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar8.jpg'); ?>" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar4.jpg'); ?>" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                ...
                <div class="tab-content">
                        ...
                        <div class="mt-actions">
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar10.jpg'); ?>" /> </div>
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar3.jpg'); ?>" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar2.jpg'); ?>" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar7.jpg'); ?>" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar9.jpg'); ?>" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                    ...
                    <div class="tab-pane" id="tab_actions_completed">
                        ...
                        <div class="mt-actions">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="<?= Yii::getAlias('@web/static/images/avatar5.jpg'); ?>" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                    ...
                    <div class="events-content">
                        <ol>
                            <li class="selected" data-date="16/01/2014">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="<?= Yii::getAlias('@web/static/images/avatar80_3.jpg'); ?>" />
                                    </div>
                            ...
                            <li data-date="20/04/2014">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="<?= Yii::getAlias('@web/static/images/avatar80_1.jpg'); ?>" />
                                    </div>
                                    <div class="mt-author-name">
                            ...
                            <li data-date="20/05/2014">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="<?= Yii::getAlias('@web/static/images/avatar80_2.jpg'); ?>" />
                                    </div>
                                    <div class="mt-author-name">
                                        <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                    </div>
                            ...
                            <li data-date="15/09/2014">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="<?= Yii::getAlias('@web/static/images/avatar80_5.jpg'); ?>" />
                                    </div>
                                    <div class="mt-author-name">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body" id="chats">
                <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                    <ul class="chats">
                        <li class="out">
                            <img class="avatar" alt="" src="<?= Yii::getAlias('@web/static/images/avatar2.jpg'); ?>" />
                            <div class="message">
                        ...
                        <li class="in">
                            <img class="avatar" alt="" src="<?= Yii::getAlias('@web/static/images/avatar1.jpg'); ?>" />
                            <div class="message">
                                <span class="arrow"> </span>
                        ...
                        <li class="out">
                            <img class="avatar" alt="" src="<?= Yii::getAlias('@web/static/images/avatar3.jpg'); ?>" />
                            <div class="message">
                                <span class="arrow"> </span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="mt-widget-1">
                            ...
                            <div class="mt-img">
                                <img src="<?= Yii::getAlias('@web/static/images/avatar80_8.jpg'); ?>"> </div>
                            <div class="mt-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mt-widget-1">
                            ...
                            <div class="mt-img">
                                <img src="<?= Yii::getAlias('@web/static/images/avatar80_7.jpg'); ?>"> </div>
                            <div class="mt-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mt-widget-1">
                            ...
                            <div class="mt-img">
                                <img src="<?= Yii::getAlias('@web/static/images/avatar80_6.jpg'); ?>"> </div>
                            <div class="mt-body">
